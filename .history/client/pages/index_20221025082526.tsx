        ...
        {currentAccount == "" ? (
          ...
          <div>
            ...
            <div className="text-xl font-semibold mb-20 mt-4">
              ...
              <label>
                {" "}
                Have You finished reading book?{" "}
                <select
                  name=""
                  id=""
                  value={bookFinished}
              ...
              <button
                className="text-xl font-bold py-3 px-12 bg-orange-500 rounded-lg mb-10 ml-5 hover:scale-105 transition duration-500 ease-in-out"
                onClick={submitBook}
              >
                Add a Book
              </button>
